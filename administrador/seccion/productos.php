...
<?php 
  ...
  $accion = (isset($_POST['accion']))
    ...
    :"";
                            ...
                            // ejecución de instrucciones a BDD
  switch ($accion) {
  	case "Agregar":
  ...
  <div class="card">
      ...
      <form method="POST" enctype="multipart/form-data">
        <div class="form-group  mb-3">
          ...
          <input type="text" required readonly class="form-control  mt-2" value="<?php echo $txtID; ?> "name="txtID" id="txtID" placeholder="ID">
        </div>	

	      <div class="form-group  mb-3">
          <label for="txtNombre">Nombre:</label>
          <input type="text" required class="form-control  mt-2" value="<?php echo $txtNombre; ?>" name="txtNombre" id="txtNombre" placeholder="Nombre del libro">
        </div> 

        <div class="form-group  mb-3">
          <label for="txtNombre">Portada:</label>
          ...
          <input type="file" class="form-control  mt-2" name="txtImagen" id="txtImagen">
        </div>   
